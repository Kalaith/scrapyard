...
Balance values, ship layouts, enemies, upgrades and per-run contract modifiers are all data — see `assets/*.json` and `assets/ships/`. Open work is tracked in `TODO.md`.
